...
def seed_users():
    demo = User( id=1, first_name='Demo',last_name=fake.last_name(),user_name='demo',bio='Bacon trailblazer. Award-winning food buff. Infuriatingly humble alcohol junkie.', email='demo@aa.io',password='password',phone_number=fake.phone_number())
    ...
    Demo4=User(id=4, first_name="Kahlani",last_name=fake.last_name(),user_name=fake.user_name(), bio='Alcohol ninja. Pop culture advocate. Hardcore zombie evangelist. Certified internet fanatic. Award-winning food maven.', email=fake.email(),password=fake.password(),phone_number=fake.phone_number())
    Demo5=User(id=5, first_name="Destiny",last_name=fake.last_name(),user_name=fake.user_name(), bio='Gamer. Beer expert. Avid creator. Communicator. Web enthusiast. Unapologetic pop culture buff.', email=fake.email(),password=fake.password(),phone_number=fake.phone_number())
    Demo6=User(id=6, first_name="Amira",last_name=fake.last_name(),user_name=fake.user_name(), bio='Hipster-friendly social media fanatic. Extreme baconaholic. Food expert. Incurable beer lover. Twitter evangelist.', email=fake.email(),password=fake.password(),phone_number=fake.phone_number())
    Demo7=User(id=7, first_name="Chef Su",last_name=fake.last_name(),user_name=fake.user_name(), bio='Unapologetic student. Food lover. Zombie junkie. Music nerd. Tv maven. Twitter specialist.', email=fake.email(),password=fake.password(),phone_number=fake.phone_number())
