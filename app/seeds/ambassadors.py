...
def seed_ambassadors():
    ...
    demo2 = Ambassador(id=2,user_id=2)
    Demo3=Ambassador(id=3,user_id=3)
    ...
    Demo16=Ambassador(id=16,user_id=16)
    Demo17=Ambassador(id=17,user_id=17)
    Demo18=Ambassador(id=18,user_id=18)
    Demo19=Ambassador(id=19,user_id=19)
    Demo20=Ambassador(id=20,user_id=20)
    Demo21=Ambassador(id=21,user_id=21)
    Demo22=Ambassador(id=22,user_id=22)
    Demo23=Ambassador(id=23,user_id=23)
    Demo24=Ambassador(id=24,user_id=24)
    Demo25=Ambassador(id=25,user_id=25)
    Demo26=Ambassador(id=26,user_id=26)
