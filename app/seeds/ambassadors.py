...
def seed_ambassadors():
    ...
    demo2 = Ambassador(user_id=2)
    Demo3=Ambassador(user_id=3)
    ...
    Demo16=Ambassador(user_id=16)
    Demo17=Ambassador(user_id=17)
    Demo18=Ambassador(user_id=18)
    Demo19=Ambassador(user_id=19)
    Demo20=Ambassador(user_id=20)
    Demo21=Ambassador(user_id=21)
    Demo22=Ambassador(user_id=22)
    Demo23=Ambassador(user_id=23)
    Demo24=Ambassador(user_id=24)
    Demo25=Ambassador(user_id=25)
    Demo26=Ambassador(user_id=26)
