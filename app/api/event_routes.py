...
def single_event(eventId):
    try:
        ...
        print(type(e))
        return {'errors': ['Cannot Get A Single Event Info, Please Try again']}, 500
...
def events(param):
    try:
        ...
        print(type(e))
        return {'errors': ['Cannot Get All Events, Please Try again']}, 500
...
def new_event():
    try:
        ...
        print(type(e))
        return {'errors': ['Cannot Get Create New Event, Please Try again']}, 500
...
def user_events():
    try:
        ...
        print(type(e))
        return {'errors': ['Cannot Get Events Booked By User, Please Try again']}, 500
...
def delete_booking(id):
    try:
        ...
        print(type(e))
        return {'errors': ['Cannot Delete Event Booking, Please Try again']}, 500
    
# DELETES AMBASSADOR EVENT
...
def delete_event(id):
    try:
        ...
        print(type(e))
        return {'errors': ['Cannot Delete Ambassador Booking, Please Try again']}, 500    