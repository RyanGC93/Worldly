      ...
      <div className="flip-animation">
        {toggle && 
          <section className="item-card">
            ...
            <div className="item-buttons front-buttons">
              <button className="btn-details blue" aria-label="Learn more about the band and venue" onClick={()=>setToggle(false)}> Details</button>
        ...
        {!toggle &&
          ...
          <div className="item-buttons back">
            ...
            <a className="btn-tickets blue on-back" aria-label="Purchase tickets for this event" href="#">Event Page</a>
          </div>
        </section>
        }
    </div>
